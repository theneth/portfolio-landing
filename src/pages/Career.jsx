import { LuBriefcase, LuMapPin, LuCalendar, LuCheckCircle2, LuTerminal, LuFolderGit2 } from "react-icons/lu";
                    ...
                    <ul className="achievement-list">
                      {company.responsibilities.map((resp, i) => (
                        <li key={i} className="achievement-item">
                          <LuCheckCircle2 className="achievement-icon" aria-hidden="true" />
                          <span>{resp}</span>
                        </li>
                      ))}
                    </ul>
